  ...
  <body class="bg-light">
    ...
    <div class="container">
      ...
      <div class="py-5 text-center">
        ...
        <p class="lead">Preencha os dados do cliente e os equipamentos!</p>
      </div>
          ...
          <form class="needs-validation" novalidate>
            <div class="row">
              <div class="col-md-6 mb-2">
                ...
                <div class="invalid-feedback">
                  É obrigatório inserir um tipo de equipamento.
                </div>
              </div>
              <div class="col-md-6 mb-2">
                ...
                <div class="invalid-feedback">
                  É obrigatório inserir uma marca.
                </div>
              </div>
            </div>
            <div class="mb-2">
            <div class="row">
              ...
              <div class="col-md-6 mb-2">
                ...
                <input type="text" class="form-control" id="numero_serie" name="serie">
              </div>
            </div>
            </div>
            <div class="mb-2">
              <label for="defeitos">Problema Reclamado</label>
              <input type="text" class="form-control" id="defeito" name="defeito" required>
              <div class="invalid-feedback">
                  É obrigatório inserir um defeito ou problema.
                </div>
            </div>
            <div class="mb-2">
              <label for="defeitos">Acessórios</label>
              <input type="textarea" class="form-control" id="acessorios" name="acessorios">
            </div>
            <br>
