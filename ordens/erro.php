    ...
    <div class="container">
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            <li class="nav-item ">
              <a class="nav-link" href="cartuchos">Cartuchos<span class="sr-only">(Página atual)</span></a>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="lista">Ordens de Serviço</a>
            </li>
            <li class="nav-item">
      ...
      <div class="py-5 text-center">
        <h2>Ocorreu um erro!!! Contate o administrador!</h2>
        <p class="lead"><a href="cadastrar">Voltar</a></p>
      </div>
    <br>
